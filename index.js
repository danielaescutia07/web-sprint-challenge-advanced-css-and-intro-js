...
function addArtist(array, id, name, years, genre, nationality, bio) {
  ...
  console.log('Task 6:', addArtist(artists, 20, 'Daniela', '1988', 'Web Design', 'Mexican', 'Born in Mexico and moved to U.S. at an early age. She experienced the difference between two countries. Overcoming obstacles became a hobby and currently facing the biggest one... BECOMING THE BEST VERSION OF HERSELF.'));
